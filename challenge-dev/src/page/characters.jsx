...
import Modal from '../components/Presentation';
...
function Characters(){
    ...
    const {data: filterData, error: filterError} = useQuery(FILTER_CHARACTER,{variables:{numberPage: pageNumber}})
    ...
    return <div>
        ...
        <section className='header'>
          ...
          <span className='kimche'>EmerM<img className='logo' src='/logo.png'/></span>
        </section>

        <div>
         <div className='filters'>
          <section className='search'>
              <input name='Input' type="text" placeholder="🔍︎" value={inputValue} onChange={handleSelects}/>
      ...
      {error ? <h1>Error Found Characters</h1> :( loading ? <Loading/> :
